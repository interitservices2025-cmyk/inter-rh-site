...
const contactInfo: {
...
}[] = [
  {
    ...
    title: "Notre adresse",
    lines: [
      { text: "Rue 2.365, Yaoundé-Tsinga, Cameroun (Derrière Tradex)" },
    ],
    id: "contact-address",
  },
  {
    ...
    title: "Téléphone",
    lines: [
      { text: "+237 679 033 398", href: "tel:+237679033398" },
      { text: "+237 695 296 446", href: "tel:+237695296446" },
    ],
    id: "contact-phone",
  },
  {
    ...
    title: "Email",
    lines: [
      { text: "contact@inter-rh.com", href: "mailto:contact@inter-rh.com" },
    ],
    id: "contact-email",
  },
  {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <AnimatedSection animation="slide-right" delay={0.2}>
                <div className="card p-8 md:p-10 border border-gray-100 bg-white">
      ...
      <section className="section-light">
        <div className="container-xl">
          <AnimatedSection animation="scale-in">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6 bg-white rounded-3xl p-8 shadow-card border border-gray-50">
              <div>
